...
public class FancyButton extends LinearLayout{
    ...
    private void initAttributsArray(TypedArray attrsArray){
        ...
        mDefaultTextColor 				= attrsArray.getColor(R.styleable.FancyButtonsAttrs_fbtextColor,mDefaultTextColor);
        ...
        mDefaultTextSize				= (int) attrsArray.getDimension(R.styleable.FancyButtonsAttrs_fbtextSize,mDefaultTextSize);
        ...
        mBorderWidth					= (int) attrsArray.getDimension(R.styleable.FancyButtonsAttrs_width_border,mBorderWidth);
        
        mRadius 						= (int)attrsArray.getDimension(R.styleable.FancyButtonsAttrs_fbradius,mRadius);
