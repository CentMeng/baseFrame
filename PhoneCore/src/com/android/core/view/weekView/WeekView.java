package com.android.core.view.weekView;
...
public class WeekView extends View {
    ...
    private Paint mTimeAnotherTextPaint;
    ...
    private int mAnotherTextSize = 10;
    private int mHeaderColumnPadding = 10;
    private int mHeaderColumnTextColor = Color.BLACK;
    private int mHeaderColumnAnotherTextColor = Color.rgb(18,173,250);
            ...
            if (mEventRects != null && mEventClickListener != null) {
                ...
                for (EventRect event : reversedEventRects) {
                    if (event.rectF != null && e.getX() > event.rectF.left && e.getX() < event.rectF.right && e.getY() > event.rectF.top && e.getY() < event.rectF.bottom) {
                        ...
                        mEventClickListener.onEventClick(event.originalEvent, event.rectF, selectedTime);
    ...
    private void init() {
        ...
        //时间列第二个时间显示
        mTimeAnotherTextPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mTimeAnotherTextPaint.setTextAlign(Paint.Align.RIGHT);
        mTimeAnotherTextPaint.setTextSize(mTextSize);
        mTimeAnotherTextPaint.setColor(mHeaderColumnAnotherTextColor);
        Rect rect = new Rect();
    ...
    private void initTextTimeWidth() {
        ...
        for (int i = 0; i < 24; i++) {
            ...
            String times[] = getDateTimeInterpreter().interpretTime(i).split(",");
...
//            String time = getDateTimeInterpreter().interpretTime(i);
            ...
            if (top < getHeight()) {
                ...
                if(!TextUtils.isEmpty(time1)){
                    canvas.drawText(time1, mTimeTextWidth + mHeaderColumnPadding, top + mTimeTextHeight*2+20, mTimeAnotherTextPaint);
                }
